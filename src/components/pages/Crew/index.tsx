...
const Crew = () => {
  ...
  return (
    <motion.section initial="hidden" whileInView="visible" className="crew">
      <div className="container">
        <motion.h4 variants={elementAnimation} className="page__title">
        ...
        <div className="crew__inner">
          {error ? (
            ...
            <>
              <div className='crew__slider-wrapper'>
                <Slider {...settings}>
                  {items.map((obj) => (
                    <CrewBlock key={obj.role} {...obj} />
                  ))}
                </Slider>
              </div>
            </>
